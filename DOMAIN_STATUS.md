...
- Google Search Console: Domain property verified with the registrar TXT record; sitemap accepted with 16 discovered pages; homepage added to the priority crawl queue
